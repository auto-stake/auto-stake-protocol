...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Auto-Stake";
    string internal constant SYMBOL = "AUTO-STAKE";
...
contract AutoStake is Auto_Stake{

    constructor() Auto_Stake(Env.MainnetV2){
